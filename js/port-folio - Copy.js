...
.holder{
  ...
  render() {
	...
	<div class="" class="${this.holderview ? 'holder-con' : 'modelclose' } ">

${this.cat =='img'  ? this.holderview = 0 : this.holderview = true }	
 <iframe width="100%"  height="100%"  frameborder="0" class="holder" src="${this.cat =='img'  ? '' : 'http://experiencethecircuit.com/' }" ></iframe>  </div>
